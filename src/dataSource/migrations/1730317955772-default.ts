...
export class Default1730317955772 implements MigrationInterface {
    name = 'Default1730317955772'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "cliente" ("id" SERIAL NOT NULL, "nome" character varying NOT NULL, "cpf" character varying NOT NULL, "celular" character varying NOT NULL, "cep" integer NOT NULL, "address" text NOT NULL, CONSTRAINT "PK_18990e8df6cf7fe71b9dc0f5f39" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "pedido" ("id" SERIAL NOT NULL, "valor" integer NOT NULL, "datadoPedido" TIMESTAMP NOT NULL, "datadeDevolucao" TIMESTAMP NOT NULL, CONSTRAINT "PK_af8d8b3d07fae559c37f56b3f43" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user_pedido" ("user_id" integer NOT NULL, "pedido_id" integer NOT NULL, CONSTRAINT "PK_c5055dbb31659bbfefb234ef711" PRIMARY KEY ("user_id", "pedido_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_61fdf29765dc612a73a7ad18ad" ON "user_pedido" ("user_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_10ab0219c0417d91b176fe5b32" ON "user_pedido" ("pedido_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "user_pedido" ADD CONSTRAINT "FK_61fdf29765dc612a73a7ad18adc" FOREIGN KEY ("user_id") REFERENCES "pedido"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "user_pedido" ADD CONSTRAINT "FK_10ab0219c0417d91b176fe5b321" FOREIGN KEY ("pedido_id") REFERENCES "cliente"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_pedido" DROP CONSTRAINT "FK_10ab0219c0417d91b176fe5b321"`);
        await queryRunner.query(`ALTER TABLE "user_pedido" DROP CONSTRAINT "FK_61fdf29765dc612a73a7ad18adc"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_10ab0219c0417d91b176fe5b32"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_61fdf29765dc612a73a7ad18ad"`);
        await queryRunner.query(`DROP TABLE "user_pedido"`);
